...
public class ProductsRecord extends UpdatableRecordImpl<ProductsRecord> implements Record4<Integer, String, String, Integer> {
    ...
    /**
     * Setter for <code>public.products.manufacturer</code>.
     */
    public ProductsRecord setManufacturer(String value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>public.products.manufacturer</code>.
     */
    ...
    public Field<String> field3() {
        return Products.PRODUCTS.MANUFACTURER;
    }
     ...
     */
    public ProductsRecord(Integer id, String name, String manufacturer, Integer quantity) {
        super(Products.PRODUCTS);
    ...
    public ProductsRecord(String name, String manufacturer, Integer quantity) {
        super(Products.PRODUCTS);
