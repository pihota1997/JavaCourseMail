...
public class Organizations extends TableImpl<OrganizationsRecord> {
    ...
    /**
     * The column <code>public.organizations.tin</code>.
     */
    public final TableField<OrganizationsRecord, String> TIN = createField(DSL.name("tin"), SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>public.organizations.current_account</code>.
     */
    public final TableField<OrganizationsRecord, String> CURRENT_ACCOUNT = createField(DSL.name("current_account"), SQLDataType.VARCHAR(20).nullable(false), this, "");
