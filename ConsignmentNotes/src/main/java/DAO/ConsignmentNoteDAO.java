...
public class ConsignmentNoteDAO implements DAO<ConsignmentNote> {
    ...
    @Override
    public @NotNull ConsignmentNote get(int id) {
    ...
    public void create(@NotNull ConsignmentNote entity) {
        try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO consignment_notes(date, organization) " +
                "VALUES (?, ?)")) {
